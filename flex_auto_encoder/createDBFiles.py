...
'''
ds0 = PointCloudDataFlow('train',num_points=1024, load_ram=True, normals=True, model_ver="10")
ds1 = PrefetchDataZMQ(ds0, nr_proc=2)
LMDBSerializer.save(ds1, '/graphics/scratch/students/heid/pointcloud_data/ModelNet40/model10-train-1024.lmdb')

ds0 = PointCloudDataFlow('test',num_points=1024, load_ram=True, normals=True, model_ver="10")
ds1 = PrefetchDataZMQ(ds0, nr_proc=2)
LMDBSerializer.save(ds1, '/graphics/scratch/students/heid/pointcloud_data/ModelNet40/model10-test-1024.lmdb')
ds0 = PointCloudDataFlow('train',num_points=1024, load_ram=True, normals=True, model_ver="40")
ds1 = PrefetchDataZMQ(ds0, nr_proc=2)
LMDBSerializer.save(ds1, '/graphics/scratch/students/heid/pointcloud_data/ModelNet40/model40-train-1024.lmdb')

ds0 = PointCloudDataFlow('test',num_points=1024, load_ram=True, normals=True, model_ver="40")
ds1 = PrefetchDataZMQ(ds0, nr_proc=2)
LMDBSerializer.save(ds1, '/graphics/scratch/students/heid/pointcloud_data/ModelNet40/model40-test-1024.lmdb')


ds0 = PointCloudDataFlow('train',num_points=10000, load_ram=True, normals=True, model_ver="10")
ds1 = PrefetchDataZMQ(ds0, nr_proc=2)
LMDBSerializer.save(ds1, '/graphics/scratch/students/heid/pointcloud_data/ModelNet40/model10-train-10000.lmdb')

ds0 = PointCloudDataFlow('test',num_points=10000, load_ram=True, normals=True, model_ver="10")
ds1 = PrefetchDataZMQ(ds0, nr_proc=2)
LMDBSerializer.save(ds1, '/graphics/scratch/students/heid/pointcloud_data/ModelNet40/model10-test-10000.lmdb')


ds0 = PointCloudDataFlow('train',num_points=10000, load_ram=True, normals=True, model_ver="40")
ds1 = PrefetchDataZMQ(ds0, nr_proc=2)
LMDBSerializer.save(ds1, '/graphics/scratch/students/heid/pointcloud_data/ModelNet40/model40-train-10000.lmdb')

ds0 = PointCloudDataFlow('test',num_points=10000, load_ram=True, normals=True, model_ver="40")
ds1 = PrefetchDataZMQ(ds0, nr_proc=2)
LMDBSerializer.save(ds1, '/graphics/scratch/students/heid/pointcloud_data/ModelNet40/model40-test-10000.lmdb')
