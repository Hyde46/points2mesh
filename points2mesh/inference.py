...
def loadModel():
    prediction = PredictConfig(
        session_init=get_model_loader("/graphics/scratch/students/heid/train_log/fusion_c1_1024_big_/checkpoint"),
...
for c in categories:
    ...
    path_output = "/graphics/scratch/students/heid/inference/c3_1024_"+c
    counter = 0
    for pc in pcs:
