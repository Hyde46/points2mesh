...
\begin{center}
    \captionof{table}{Distance metric evaluations with 256 samples per point cloud. Caluclated with \emph{meshdistance} metric. Only considering configurations $\mathcal{C}_1$ and $\mathcal{C}_2$. Lower values are better.} \label{tab:distance1024} 
...
\end{center}
\begin{center}
    \captionof{table}{Distance metric evaluations with 7500 samples per point cloud. Caluclated with \emph{meshdistance} metric.Only considering configurations $\mathcal{C}_1$ and $\mathcal{C}_2$. Lower values are better.} \label{tab:distance1024} 
    \begin{tabular}{| l  | c | c | c | c | c | c | c |}
        \hline
        %airplane
...
\begin{center}
    \captionof{table}{Excerpt of evaluation table. Distance metric evaluations with 1024 samples per point cloud. Initial mesh (~torus mesh~) with a \emph{genus} of one.} \label{tab:distance7500} 
    \begin{center}
        \begin{tabular}{| l  | c | c |}
            \hline
            %airplane
...
\begin{center}
    \captionof{table}{Excerpt of evaluation table. Distance metric evaluations with 1024 samples per point cloud. Comparison of configuration $\mathcal{C}_1$ trained with and without noise (\emph{noise level} of 0.01). Inference with noisy data of the same \emph{noise level}.} \label{tab:distance7500} 
    \begin{center}
        \begin{tabular}{| l  | c | c |}
            \hline
            %airplane
