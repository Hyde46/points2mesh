...
\subsection{Distance metric results}
    ...
    Tables \ref{distance256opt}, \ref{distance1024opt} and \ref{distance256opt} show the same evaluation of $d_m$ for $\mathcal{N}_{opt}$, though only the mean value
...
\begin{center}
    ...
    \begin{tabular}{| l  | c  | c | c | c | c | c || c |}
        ...
        car&0.0 20&&0.019&0.020&0.020&0.199&0.155\\\hline
        ...
        mean&0.020&&0.021&0.016&0.016&0.200&0.1986\\\hline
    \end{tabular}
\end{center}
\begin{center}
    ...
    \begin{tabular}{| l  | c | c | c | c | c | c || c |}
        ...
        mean&0.017&&0.021&0.015&0.016&0.134 & 0.1986\\        \hline
    \end{tabular}
\end{center}
